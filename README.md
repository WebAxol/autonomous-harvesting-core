...
Six layers inside one assembly, dependencies pointing strictly downward:
...
The library project has no test runner dependency; if a test project is added under `src/`, run it with `dotnet run` from that project's directory.
